...
public class OfferingListAdapter extends ArrayAdapter<Offering> {
    ...
    public View getView(int pos, View convertView, ViewGroup parent)
    {
        ...
        TextView offeringListCRNtextView = view.findViewById(R.id.offeringListCRNTextView);
        ...
        offeringListCRNtextView.setText(Integer.toString(selectedOffering.getCRN()));
